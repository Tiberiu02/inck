...
function UserDetails({ }) {
    ...
    const resetPassword = async () => {
        try {
            ...
            if (json.status == "success") {
                setTempMessage("Password reset successfully requested")
            } else {
    ...
    return (<div className="flex flex-col pl-5 pt-3">
        ...
        {detailsFetched &&
            <div className="flex flex-col gap-4">
                ...
                <button
                    ...
                    className="text-l h-8 bg-gray-200 font-medium hover:text-slate-50 hover:bg-slate-800 flex items-center justify-center rounded-md px-3 w-80"
                >
                    Reset password
                </button>
                <div className={`${successMessage == "" ? "hidden" : ""} px-2 bg-green-500 py-2 rounded-sm shadow-md text-white`}>
                    {successMessage}
                </div>
                <div className={`${error == "" ? "hidden" : ""} px-2 bg-red-500 py-2 rounded-sm shadow-md text-white`}>
                    Error: {error}
                </div>
            </div>
        }
            ...
            <div className="relative flex flex-col w-[100vw] h-[100vh]">
                ...
                <div className="flex flex-row gap-10 sm:gap-10 justify-between h-16 items-center px-4 sm:px-6 border-b-[1px] bg-white border-gray-300">
                    ...
                    <div className="hidden sm:flex flex-row gap-2">
                        ...
                        <a href="faq" className="hover:bg-gray-300 flex 
                ...
                <div className="flex h-full w-full">
                    ...
                    <div className="h-full w-[15rem] border-r-2">
                        <div className="flex space-x-0 gap-x-2 items-center 
                        justify-center bg-gray-200 py-3">
