    ...
    <div>
      ...
      <main>
        <div className='flex flex-col w-[100vw] h-[100vh] font-round'>
          ...
          { /** Navigation bar */}
          <div className='flex flex-row justify-between h-16 items-center px-8 border-b-[1px] border-gray-300'>
            <div className='flex flex-row gap-3 items-center text-primary'>
              <Icon.FaPencilAlt className='text-2xl mt'/>
              <p className='font-cursive font-bold tracking-wider text-2xl'>Inck</p>
            </div>
            <div className='bg-gray-100 text-gray-500 flex flex-row items-center h-10 w-full max-w-xl rounded-lg'>
          ...
          <div className='h-full w-full flex flex-row pt-4 overflow-hidden'>
            { /** Directory browser */}
            <div className='h-full w-96 border-r-[1px] flex flex-col' style={{overflow: 'overlay'}}>
